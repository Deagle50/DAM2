...
public class RecyclerVersionAdapter extends RecyclerView.Adapter<RecyclerVersionAdapter.ViewHolder> {
    private int resource;
    private Context parent;
    private ArrayList<AndroidVersion> lista;

    public RecyclerVersionAdapter(Context context,int res, ArrayList<AndroidVersion> list) {
        parent=context;
        resource=res;
        lista=list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new RecyclerVersionAdapter.ViewHolder(v,txtName,txtVersion,txtApi,txtYear,imgLogo);
    }
